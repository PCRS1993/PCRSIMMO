	...
	<div class = "store-mart-lite-footer-wrap ">
		<div class="store-mart-lite-container clearfix">
			<div class = "store-mart-lite-footer-copyright">
				...
				<?php esc_html_e( 'WordPress Theme : ', 'zigcy-lite' );  ?><a href="<?php echo esc_url( __( 'https://accesspressthemes.com/wordpress-themes/zigcy-lite', 'zigcy-lite' ) ); ?>"><?php esc_html_e( 'Zigcy Lite', 'zigcy-lite' ); ?> </a>
			</div>
