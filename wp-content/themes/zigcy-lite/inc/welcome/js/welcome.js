...
jQuery(document).ready(function ($) {
	...
	$(".install").on('click', function (e) {
    	...
    	var ajaxurl = ZigcyLiteWelcomeObject.ajaxurl;
		...
		$.ajax({
			...
			data: {
				...
				nonce: ZigcyLiteWelcomeObject.admin_nonce,
			},
			success: function(response) {
		   		...
		   		if(response == 'success'){
				   		...
				   		el.html(ZigcyLiteWelcomeObject.installed_btn);
	...
	$(".plugin-action-btn .activate").on('click', function (e) {
		...
		$.ajax({
	   		...
	   		data: {
	   			...
	   			plugin: plugin,
	   			plugin_file: plugin_file,
	   			nonce: ZigcyLiteWelcomeObject.activate_nonce,
	   			dataType: 'json'
	   		},
	   		success: function(response) {
	   			el.removeClass('installing');
	...
	$(".plugin-action-btn .deactivate").on('click', function (e) {
		...
		$.ajax({
	   		...
	   		data: {
	   			...
	   			plugin: plugin,
	   			plugin_file: plugin_file,
	   			nonce: ZigcyLiteWelcomeObject.deactivate_nonce,
	   			dataType: 'json'
	   		},
	   		success: function(response) {
	   			el.removeClass('installing');
