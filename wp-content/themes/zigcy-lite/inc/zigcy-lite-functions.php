...
if( ! function_exists('zigcy_lite_formated_date')){
    function zigcy_lite_formated_date(){
        ...
        }elseif($date_format == 'F j, Y'){
            $date = '<div class="blog-date-inner default-date"><span class="posted-month">%1$s</span><span class="ym-wrapp"><span class="posted-day">%2$s</span><span class="posted-yearss">%3$s</span></span></div>';
            $date = sprintf( $date,
              date_i18n('F'),
              date_i18n('j'),
              date_i18n('Y')
...
*/
add_action( 'wp_ajax_vcm_woo_tab_ajax','vcm_woo_tab_ajax' );
add_action( 'wp_ajax_nopriv_vcm_woo_tab_ajax','vcm_woo_tab_ajax' );
if(!function_exists('vcm_woo_tab_ajax')){
    function vcm_woo_tab_ajax(){
